...
import {
  Video, Monitor, Edit, Share2, Shield,
  Star, ArrowRight, PlayCircle, Sparkles
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 overflow-hidden relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="neon-line neon-line-horizontal neon-primary absolute top-1/4 left-0 opacity-40 dark:opacity-100" style={{ animationDelay: '0s' }} />
        <div className="neon-line neon-line-horizontal neon-cyan absolute top-1/2 left-0 opacity-40 dark:opacity-100" style={{ animationDelay: '4s' }} />
        <div className="neon-line neon-line-horizontal neon-purple absolute top-3/4 left-0 opacity-40 dark:opacity-100" style={{ animationDelay: '8s' }} />

        {/* Vertical flowing lines */}
        <div className="neon-line neon-line-vertical neon-green absolute top-0 left-1/4 opacity-40 dark:opacity-100" style={{ animationDelay: '2s' }} />
        <div className="neon-line neon-line-vertical neon-pink absolute top-0 right-1/3 opacity-40 dark:opacity-100" style={{ animationDelay: '6s' }} />
        <div className="neon-line neon-line-vertical neon-orange absolute top-0 right-1/4 opacity-40 dark:opacity-100" style={{ animationDelay: '10s' }} />

        {/* Orbital neon elements */}
        <div className="absolute top-1/3 left-1/3">
          <div className="neon-orbit neon-primary opacity-60 dark:opacity-100" style={{ animationDelay: '0s' }} />
        </div>
        <div className="absolute top-2/3 right-1/4">
          <div className="neon-orbit neon-purple opacity-60 dark:opacity-100" style={{ animationDelay: '5s' }} />
        </div>
        <div className="absolute bottom-1/4 left-1/2">
          <div className="neon-orbit neon-cyan opacity-60 dark:opacity-100" style={{ animationDelay: '10s' }} />
        </div>
        ...
        <div className="absolute top-0 right-0 w-32 h-0.5 bg-gradient-to-l from-purple-500 to-transparent neon-pulse opacity-70 dark:opacity-100" style={{ animationDelay: '1s' }} />
        <div className="absolute top-0 right-0 w-0.5 h-32 bg-gradient-to-b from-purple-500 to-transparent neon-pulse opacity-70 dark:opacity-100" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-0 left-0 w-32 h-0.5 bg-gradient-to-r from-cyan-500 to-transparent neon-pulse opacity-70 dark:opacity-100" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-0 left-0 w-0.5 h-32 bg-gradient-to-t from-cyan-500 to-transparent neon-pulse opacity-70 dark:opacity-100" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-0 right-0 w-32 h-0.5 bg-gradient-to-l from-green-500 to-transparent neon-pulse opacity-70 dark:opacity-100" style={{ animationDelay: '3s' }} />
        <div className="absolute bottom-0 right-0 w-0.5 h-32 bg-gradient-to-t from-green-500 to-transparent neon-pulse opacity-70 dark:opacity-100" style={{ animationDelay: '3s' }} />
      </div>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <SignInButton>
                <button className="text-gray-200 hover:text-gray-100 font-medium transition-all duration-200 hover:scale-105">
                  Sign In
                </button>
              </SignInButton>
              <SignUpButton>
                <button className="bg-gradient-to-r from-primary-500 to-purple-500 text-white px-6 py-2 rounded-full hover:shadow-lg hover:shadow-primary-500/25 font-medium transition-all duration-200 hover:scale-105">
                  Get Started
                </button>
              </SignUpButton>
            </div>
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10" style={{ paddingTop: '2rem' }}>
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-primary-500/20 to-purple-500/20 rounded-full border border-primary-500/30 mb-8">
              ...
              <span className="text-sm text-primary-700 dark:text-primary-300 font-medium">New: AI-powered captions now available</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-16 max-w-3xl mx-auto leading-relaxed">
              Create stunning screen recordings with our comprehensive suite of tools.
              Built-in editing, AI captions, and sophisticated sharing controls — all in one platform.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
              <SignUpButton>
                <button className="group bg-gradient-to-r from-primary-500 to-purple-500 text-white px-12 py-6 rounded-full hover:shadow-xl hover:shadow-primary-500/25 font-medium text-2xl transition-all duration-300 hover:scale-105 flex items-center">
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="bg-gradient-to-br from-white/80 to-gray-50/80 dark:from-gray-800/50 dark:to-gray-900/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-2xl p-6 hover:border-primary-500/50 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-gray-500 dark:text-gray-400 text-sm uppercase tracking-wide">{stat.label}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 relative z-10">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="neon-line neon-line-horizontal neon-purple absolute top-10 left-0 opacity-40 dark:opacity-100" style={{ animationDelay: '1s', width: '150px' }} />
          <div className="neon-line neon-line-horizontal neon-cyan absolute bottom-10 right-0 opacity-40 dark:opacity-100" style={{ animationDelay: '3s', width: '200px' }} />
          ...
          <div className="absolute top-1/2 right-4 w-1 h-24 bg-gradient-to-b from-transparent via-purple-600 dark:via-purple-400 to-transparent opacity-40 dark:opacity-60 neon-pulse" style={{ animationDelay: '1.5s' }} />
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mx-auto">
              From capture to sharing, ScreenForge provides all the tools you need
              to create and distribute professional screen recordings.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 relative">
            {features.map((feature, index) => {
              ...
              const getCardClasses = (index: number) => {
                if (index === 0) return "lg:col-span-2 lg:row-span-1"; // Rectangle (wide)
                if (index === 1) return "lg:col-span-1 lg:row-span-1";  // Square
                if (index === 2) return "lg:col-span-1 lg:row-span-1";  // Square
                if (index === 3) return "lg:col-span-2 lg:row-span-1";  // Rectangle (wide)
                return "";
              };
              ...
              return (
                <div
                  key={index}
                  className={`group relative ${getCardClasses(index)}`}
                ...
                >
                  ...
                  <div className={`bg-gradient-to-br from-white/80 to-gray-50/80 dark:from-gray-800/50 dark:to-gray-900/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-2xl p-6 lg:p-8 hover:border-primary-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-2 relative z-10 h-full ${
                    index === 0 || index === 3
                    ...
                    <div className={`${
                      ...
                      <div className={`bg-gradient-to-r ${feature.gradient} w-16 h-16 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 ${
                        index === 0 || index === 3 ? 'mx-auto lg:mx-0' : 'mx-auto'
                      }`}>
                        <Icon className="h-8 w-8 text-white" />
                      </div>
                    </div>
                    <div className={`flex-1 ${index === 0 || index === 3 ? 'text-center lg:text-left' : 'text-center'}`}>
            ...
            {[
              {
                icon: '🌐',
                title: 'Browser Tab',
                description: 'Record a specific browser tab for focused demonstrations',
                color: 'from-gray-700 to-gray-600'
              },
              {
                icon: '🖥️',
                title: 'Browser Window',
                description: 'Capture entire browser window including multiple tabs',
                color: 'from-gray-700 to-gray-600'
              },
              {
                icon: '🖨️',
                title: 'Full Desktop',
                description: 'Record your entire screen for comprehensive tutorials',
                color: 'from-gray-700 to-gray-600'
              }
            ].map((option, index) => (
              <div key={index} className="group relative">
                <div className="bg-gradient-to-br from-white/80 to-gray-50/80 dark:from-gray-800/50 dark:to-gray-900/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-2xl p-8 hover:border-primary-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-2">
                  <div className="text-center">
                    <div className={`bg-gradient-to-r ${option.color} w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 text-3xl`}>
                      {option.icon}
                    </div>
                    <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">{option.title}</h3>
      ...
      <section className="py-24 relative z-10">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="neon-line neon-line-vertical neon-green absolute top-0 left-8 opacity-40 dark:opacity-100" style={{ animationDelay: '2s', height: '120px' }} />
          <div className="neon-line neon-line-vertical neon-pink absolute top-0 right-8 opacity-40 dark:opacity-100" style={{ animationDelay: '4s', height: '150px' }} />
        ...
        <div className="container mx-auto px-4 text-center relative">
          <div className="bg-gradient-to-br from-primary-500/10 to-purple-500/10 backdrop-blur-sm border border-primary-500/20 rounded-3xl p-16 relative">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-10 mx-auto">
              Join thousands of creators, designers, and developers who trust ScreenForge
              for their screen recording needs.
            </p>
            <SignUpButton>
              <button className="group bg-gradient-to-r from-primary-500 to-purple-500 text-white px-12 py-4 rounded-full hover:shadow-xl hover:shadow-primary-500/25 font-medium text-xl transition-all duration-300 hover:scale-105 flex items-center mx-auto">
                Get Started Free
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-8">
              <a href="#" className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">Privacy</a>
              <a href="#" className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">Terms</a>
              <a href="#" className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">Support</a>
            </div>
          </div>
          <div className="border-t border-gray-200/30 dark:border-gray-800/30 mt-12 pt-8 text-center">
            <p className="text-gray-500">
              © 2025 ScreenForge. Professional screen recording made simple.
            </p>
          </div>
        </div>
      </footer>
